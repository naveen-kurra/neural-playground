...
const ISSUE_META: Record<string, { title: string; severity: "error" | "warning" }> = {
  ...
  missing_incoming_edge: { title: "Unconnected Input", severity: "error" },
  missing_outgoing_edge: { title: "Unconnected Output", severity: "error" },
  node_input_arity: { title: "Too Many Inputs", severity: "error" },
  node_output_arity: { title: "Too Many Outputs", severity: "error" },
